...
// import 'package:flutter/page_transitions_theme.dart';
...
///    for this route.
///  * [MaterialPageV2], which is a [Page] of this class.
class MaterialPageRouteV2<T> extends PageRoute<T>
...
/// See also:
///
///  * [MaterialPageRouteV2], which is the [PageRoute] version of this class
class MaterialPageV2<T> extends Page<T> {
  /// Creates a material page.
  const MaterialPageV2({
    required this.child,
    this.maintainState = true,
  ...
  Route<T> createRoute(BuildContext context) {
    return _PageBasedMaterialPageRouteV2<T>(page: this);
  }
}
...
class _PageBasedMaterialPageRouteV2<T> extends PageRoute<T>
    with MaterialRouteTransitionMixin<T> {
  _PageBasedMaterialPageRouteV2({
    required MaterialPageV2<T> page,
  })  : assert(page != null),
        super(settings: page) {
    // assert(opaque);
  }
  ...
  MaterialPageV2<T> get _page => settings as MaterialPageV2<T>;
